...
public interface IProductService {
    ...
    DataResult<Page<GetAllProductResponse>> getAllProductsWithPage(Pageable pageable);
    DataResult<Slice<GetAllProductResponse>> getAllProductsWithSlice(Pageable pageable);
